<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="CareerHub.WebForm1" %>
    ...
    <form id="form1" runat="server" style="height:100%;">
        ...
        <div class="container">
            ...
            <div class="middle-section" id="middle-section">
                ...
                <div class="sorting">
                    Categories: <asp:DropDownList ID="ddlCategory" runat="server" CssClass="sorting-select">
